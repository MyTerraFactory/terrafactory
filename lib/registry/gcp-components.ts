...
export const gcpModuleMappings: ModuleMapping[] = [
  ...
  { resourceType: "eks", provider: "gcp", moduleSource: "terraform-google-modules/kubernetes-engine/google", version: "~> 44.0", requiredInputs: ["project_id", "name", "region", "network", "subnetwork"], optionalInputs: ["cluster_resource_labels", "deletion_protection", "horizontal_pod_autoscaling", "logging_service", "monitoring_service", "node_pools", "release_channel"], notes: "Maintained GKE module." },
  { resourceType: "rds", provider: "gcp", moduleSource: "GoogleCloudPlatform/sql-db/google//modules/postgresql", version: "~> 26.0", requiredInputs: ["project_id", "name", "database_version", "region"], optionalInputs: ["availability_type", "backup_configuration", "deletion_protection", "deletion_protection_enabled", "disk_size", "insights_config", "ip_configuration", "tier", "user_labels"], notes: "Partner Cloud SQL PostgreSQL module." },
  ...
  { resourceType: "alb", provider: "gcp", moduleSource: "terraform-google-modules/lb-http/google", version: "~> 12.0", requiredInputs: ["project", "name", "backends"], optionalInputs: ["certificate_map", "labels", "managed_ssl_certificate_domains", "security_policy", "ssl"], notes: "Maintained Google HTTPS load balancer module." }
];
