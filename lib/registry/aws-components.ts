...
export const awsModuleMappings: ModuleMapping[] = [
  { resourceType: "vpc", provider: "aws", moduleSource: "claranet/vpc/aws", version: "~> 7.0", requiredInputs: ["name", "cidr"], optionalInputs: ["az_count", "database_subnet_tags", "enable_nat_gateway", "private_subnet_tags", "public_subnet_tags", "tags"], notes: "Claranet VPC baseline with subnet tiering." },
  { resourceType: "security-group", provider: "aws", moduleSource: "claranet/security-group/aws", version: "~> 2.0", requiredInputs: ["vpc_id", "ingress_cidr_blocks"], optionalInputs: ["egress_rules", "enable_ssh", "tags"], notes: "Reusable security group rule module." },
  { resourceType: "eks", provider: "aws", moduleSource: "claranet/eks/aws", version: "~> 4.0", requiredInputs: ["cluster_name", "subnet_ids"], optionalInputs: ["cluster_enabled_log_types", "cluster_endpoint_private_access", "cluster_log_retention_in_days", "cluster_version", "node_groups", "tags", "vpc_id"], notes: "Production EKS module with managed nodes." },
  { resourceType: "rds", provider: "aws", moduleSource: "claranet/rds/aws", version: "~> 6.0", requiredInputs: ["identifier", "subnet_ids", "engine"], optionalInputs: ["allocated_storage", "backup_retention_period", "deletion_protection", "engine_version", "instance_class", "maintenance_window", "multi_az", "storage_encrypted", "tags", "vpc_security_group_ids"], notes: "Managed PostgreSQL with subnet groups and encryption." },
  { resourceType: "redis", provider: "aws", moduleSource: "claranet/elasticache/aws", version: "~> 5.0", requiredInputs: ["name", "subnet_ids"], optionalInputs: ["maintenance_window", "node_type", "replicas_per_node_group", "security_group_ids", "snapshot_retention_limit", "tags", "transit_encryption_enabled"], notes: "Redis replication group module." },
  { resourceType: "alb", provider: "aws", moduleSource: "claranet/alb/aws", version: "~> 8.0", requiredInputs: ["name", "subnets", "vpc_id"], optionalInputs: ["access_logs_enabled", "certificate_arn", "deletion_protection_enabled", "domain_name", "enable_waf", "tags"], notes: "Application load balancer with listener configuration." },
