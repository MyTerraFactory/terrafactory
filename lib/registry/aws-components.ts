...
export const awsModuleMappings: ModuleMapping[] = [
  ...
  ...awsComponentDefinitions
    .filter((definition) => !["vpc", "vpc-endpoint", "ecs", "fargate-service", "aurora", "opensearch", "guardduty", "security-hub", "cloudwatch", "codebuild", "amplify", "connect", "transfer-family", "datasync", "sagemaker", "bedrock", "shield"].includes(definition.type))
